...
namespace UnityEngine.UI
{
        ...
        ILayoutElement
    {
        ...
        {
            Debug.LogFormat("SetCaretVisible - m_AllowInput: {0}", m_AllowInput);
            if (!m_AllowInput)
                return;
        ...
        {
            //Debug.Log("Execute Backspace");
            Backspace();
        }

        public void ExecuteMoveLeft()
        {
            //Debug.Log("Execute Move Left");
            MoveLeft(false, false);
        }

        public void ExecuteMoveRight()
        {
            //Debug.Log("Execute Move Right");
